            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 padd0">
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item ">
                            <img src="assets/dist/images/vikesh.jpg" alt="institute"> 
                            <div class="carousel-caption">
                        ...
                        <div class="item">
                            <img src="assets/dist/images/slider4.jpg" alt="Chicago">
                            <div class="carousel-caption">
                                <h3>Getting started</h3>
                                <p>Improve your skills</p>
                            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
                <img src="assets/dist/images/about-ins.jpg" class="img-responsive">
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="event">
                    <div class="event-img">
                      <img class="img-responsive" src="assets/dist/images/provide.jpg">
                    </div>  
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="event">
                    <div class="event-img">
                      <img class="img-responsive" src="assets/dist/images/sm-study-material.jpg">
                    </div>  
                    <div class="event-details">
            ...
            <div class="clearfix section-gap"></div>
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="event">
                    <div class="event-img">
                      <img class="img-responsive" src="assets/dist/images/problem-solving.jpg">
                    </div>  
                    <div class="event-details">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="event">
                    <div class="event-img">
                      <img class="img-responsive" src="assets/dist/images/test-series.jpg">
                    </div>  
                    <div class="event-details">
                        <h4>Test Series</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur a dipisicing elit. Vero omnis unde nesciunt? Read more</p>
            ...
            <div id="myCarousel2" class="carousel slide text-center" data-ride="carousel">
                ...
                <nav>
                    <ul class="control-box pager">
                        ...
                        <li><a data-slide="next" href="#myCarousel2" class="color-b"><i class="glyphicon glyphicon-chevron-right"></i></a></li>
                    </ul>
                </nav>
            </div>
        </div>

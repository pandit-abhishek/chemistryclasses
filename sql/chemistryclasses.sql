...
--
-- Host: localhost
-- Generation Time: May 27, 2018 at 03:14 PM
...
(1, '127.0.0.1', 'webmaster', '$2y$08$/X5gzWjesYi78GqeAv5tA.dVGBVP7C1e1PzqnYCVe5s1qhlDIPPES', NULL, NULL, NULL, NULL, NULL, NULL, 1451900190, 1527401191, 1, 'Webmaster', ''),
...
CREATE TABLE `students` (
  `id` int(11) NOT NULL,
  `FirstName` char(31) NOT NULL,
  `MiddleName` char(31) NOT NULL,
  `LastName` char(31) NOT NULL,
  `FathersName` char(51) NOT NULL,
  `MothersName` char(51) NOT NULL,
  `dob` int(11) NOT NULL,
  `class` varchar(11) NOT NULL,
  `courses` varchar(51) NOT NULL,
  `batch` varchar(31) NOT NULL,
  `time` varchar(21) NOT NULL,
  `MobileNumber` varchar(51) NOT NULL,
  `email` varchar(51) NOT NULL,
  `FeePerMonth` int(21) NOT NULL,
  `FeePerYear` int(21) NOT NULL,
...
INSERT INTO `students` (`id`, `FirstName`, `MiddleName`, `LastName`, `FathersName`, `MothersName`, `dob`, `class`, `courses`, `batch`, `time`, `MobileNumber`, `email`, `FeePerMonth`, `FeePerYear`, `stream`, `CreatedAt`, `UpdatedAt`, `CreatedBy`, `UpdatedBy`) VALUES
(1, 'Abhishek', 'Kumar', 'Pandit', 'Krishna Kumar pandit', 'Manju Devi', 2018, 'XII', 'Pre Foundat', 'Batch - 1 ', '6:00 - 7:00', '2147483647', 'abhishek.pandit@technovihar.com', 500, 6000, 'Science', 1527411119, 1527411119, 1, 1),
(2, 'Abhishek', 'Kumar', 'Pandit', 'Krishna Kumar pandit', 'Manju Devi', 2018, 'XII', 'Pre Foundation Course', 'Batch - 1 ', '6:00 - 7:00', '2147483647', 'abhishek.pandit@ongraph.com', 500, 6000, 'Science', 1527411374, 1527411374, 1, 1);
